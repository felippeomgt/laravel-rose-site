...
class PixServiceProvider extends ServiceProvider
{
    ...
    public function __construct(){
        $this->baseUrl      = env('PIX_PSP_BASE_URL');
        $this->clientId     = env('PIX_PSP_CLIENT_ID');
        $this->clientSecret = env('PIX_PSP_CLIENT_SECRET');
        $this->oauthUrl  = env('PIX_PSP_OAUTH_URL');
        $this->certificate  = env('PIX_PSP_CERTIFICATE');
    }
